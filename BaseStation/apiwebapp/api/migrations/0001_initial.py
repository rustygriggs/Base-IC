# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-09-18 03:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('input_peripheral_service', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='input_peripheral_service', to='api.PeripheralService')),
                ('input_value', models.CharField(max_length=500)),
                ('output_peripheral_service', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='output_peripheral_service', to='api.PeripheralService')),
